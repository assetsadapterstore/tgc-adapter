...
func TestTransfer(t *testing.T) {
	...
	accountID := "FkGufUVRVsiAbN9M38PfEBzFbZqVNszZM8qwQqbQLEHW"
	...
	rawTx, err := testCreateTransactionStep(tm, walletID, accountID, to, "0.1", "", memo, &contract)
	if err != nil {
		return
	}
